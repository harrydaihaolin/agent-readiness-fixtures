# CLAUDE.md — agent-readiness-fixtures
...
2. Run `python tools/list_fixtures.py` before opening a PR.
...
`python tools/list_fixtures.py` is non-interactive. No prompts, no human input. If you add
